...
exports.sendNoticeNotification = sendNoticeNotification;
exports.sendClassNoteNotification = sendClassNoteNotification;
exports.sendClassMessageNotification = sendClassMessageNotification;
...
const notifBase = (accentColor, icon, tagline, body) => `
<!DOCTYPE html>
<html>
...
async function sendNoticeNotification(to, opts) {
    const catColors = {
...
async function sendClassNoteNotification(to, opts) {
    const body = `
...
async function sendClassMessageNotification(to, opts) {
